...
N = 4 # this is an integer controlling the size of the unit cell (twist angle)
...
from pyqula.supercell import turn_orthorombic
g = turn_orthorombic(g) # build an orthorombic one
