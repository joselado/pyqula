...
- GPU dispatch of the RPA response kernel (`chi_cpugpu="GPU"`), in single or double precision (`chi_prec`), shared by the spin/charge susceptibilities, IETS maps and RPA magnon bands
